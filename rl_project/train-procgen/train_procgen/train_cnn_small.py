...
from baselines.common.models import cnn_small
...
def train_fn(path, env_name, num_envs, distribution_mode, num_levels, start_level, timesteps_per_proc, save_interval, is_test_worker=False, log_dir='/content/drive/MyDrive/cs182_project/train-procgen/train_procgen/trained', comm=None):
    learning_rate = 5e-4
    ent_coef = .01
    gamma = .999
    lam = .95
    ...
    conv_fn = cnn_small() #lambda x: build_impala_cnn(x, depths=[16,32,32], emb_size=256)
...
def main():
    ...
    train_fn(args.model_path, args.env_name,
        args.num_envs,
        args.distribution_mode,
        args.num_levels,
        args.start_level,
        args.timesteps_per_proc, args.save_interval,
